...
class FwhfStarrySky {
    ...
    drawSky() {
        ...
        const skyStyle = this.context.createLinearGradient(0, 0, 0, this.canvas.height)
        skyStyle.addColorStop(0, this.isNight() ? '#000211' : 'rgba(135,206,250,1)')
        skyStyle.addColorStop(0.3, this.isNight() ? '#080d23' : 'rgba(135,206,250,0.3)')
        skyStyle.addColorStop(0.7, this.isNight() ? '#18203d' : 'rgba(135,206,250,0.2')
        skyStyle.addColorStop(1, this.isNight() ? '#293756' : 'rgba(135,206,250,0.1)')
    ...
    drawMountain() {
        ...
        skyStyle.addColorStop(0.5, this.isNight() ? '#111' : 'rgba(135,206,250,0.3)')
